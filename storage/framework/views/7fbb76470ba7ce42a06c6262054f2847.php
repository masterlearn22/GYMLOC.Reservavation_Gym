    ...
    <div class="container">
        <div class="row g-4 justify-content-center">
            <div class="col-md-4 col-sm-6">
                <div class="stat-card">
                    <div class="stat-number" id="state1" countTo="<?php echo e($gymCount); ?>"><?php echo e($gymCount); ?>+</div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="stat-card">
                    <div class="stat-number" id="state2" countTo="<?php echo e($facilityCount); ?>"><?php echo e($facilityCount); ?>+</div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="stat-card">
                    <div class="stat-number" id="state3" countTo="<?php echo e($cityCount); ?>"><?php echo e($cityCount); ?></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="glass-card">
                            <div class="gym-img-container">
                                <?php if($gym->foto): ?>
                                    <img src="<?php echo e(asset('storage/' . $gym->foto)); ?>" alt="<?php echo e($gym->nama_gym); ?>">
                                <?php else: ?>
                            ...
                            <div class="gym-info">
                                <h3 class="gym-title"><?php echo e($gym->nama_gym); ?></h3>
                                <div class="gym-address">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <span><?php echo e(Str::limit($gym->alamat, 40)); ?></span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mt-4">
                                    <div class="rating">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <i class="fas fa-star <?php echo e($i <= 4 ? 'text-warning' : 'text-muted'); ?> small"></i>
                                        <?php endfor; ?>
                                    </div>
                                    <a href="<?php echo e(route('gym.show', $gym->gym_id)); ?>" class="btn-outline-neon">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-center mt-5">
                    <?php echo e($gyms->withQueryString()->links()); ?>
...
<?php echo $__env->make('partials.app-dark', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYMLOC.Reservavation_Gym-master\resources\views/IntroWebsite/index.blade.php ENDPATH**/ ?>