            ...
            <div class="py-3 mx-auto col-lg-9">
                <div class="row">
                    ...
                    <div class="col-md-4 position-relative">
                        <div class="p-3 text-center">
                            <h1 class="text-gradient text-dark">
                                <span id="state1" countTo="<?php echo e($gymCount); ?>"><?php echo e($gymCount); ?></span>+
                            </h1>
                    ...
                    <div class="col-md-4 position-relative">
                        <div class="p-3 text-center">
                            <h1 class="text-gradient text-dark">
                                <span id="state2" countTo="<?php echo e($facilityCount); ?>"><?php echo e($facilityCount); ?></span>+
                            </h1>
                    ...
                    <div class="col-md-4">
                        <div class="p-3 text-center">
                            <h1 class="text-gradient text-dark" id="state3" countTo="<?php echo e($cityCount); ?>"><?php echo e($cityCount); ?></h1>
                        ...
                        <div class="card h-100 gym-card">
                            ...
                            <div class="pt-3 card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0"><?php echo e($gym->nama_gym); ?></h5>
                                    <span class="badge bg-success">Tersedia</span>
                                </div>
                                <p class="mt-2 text-sm">
                                    <i class="fas fa-map-marker-alt me-1"></i> <?php echo e($gym->alamat); ?>

                                </p>
                                <div class="mt-3 d-flex justify-content-between align-items-center">
                                    <div class="rating">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <i class="fas fa-star <?php echo e($i <= 4 ? 'text-warning' : 'text-muted'); ?>"></i>
                                        <?php endfor; ?>
                                    </div>
                                    <a href="<?php echo e(route('gym.show', $gym->gym_id)); ?>" class="btn btn-sm btn-outline-primary">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYMLOC.Reservavation_Gym-master\resources\views/IntroWebsite/index.blade.php ENDPATH**/ ?>