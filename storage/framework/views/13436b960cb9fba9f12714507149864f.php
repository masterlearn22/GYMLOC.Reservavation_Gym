            ...
            <div class="mb-4 col-md-8 col-sm-6 col-6">
                <div>
                    ...
                    <ul class="flex-column ms-n3 nav">
                        <li class="nav-item">
                            <a class="nav-link footer-link" href="<?php echo e(route('about.index')); ?>">
                                Tentang Kami
                            </a>
                        </li>
                    </ul>
...
<?php /**PATH C:\laragon\www\GYMLOC.Reservavation_Gym-master\resources\views/partials/footer.blade.php ENDPATH**/ ?>