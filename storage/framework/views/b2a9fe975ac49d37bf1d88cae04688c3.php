                ...
                <nav class="top-0 mx-4 my-3 shadow navbar navbar-expand-lg blur border-radius-xl position-absolute start-0 end-0 z-index-fixed">
                    <div class="px-0 container-fluid">
                        ...
                        <ul class="navbar-nav ms-auto d-flex align-items-center">
                            ...
                            <form action="<?php echo e(route('gym.search')); ?>" method="GET" class="d-flex align-items-center flex-grow-10">
                        ...
                        <!-- Form Pencarian dengan Filter -->
                            ...
                            <a class="text-sm navbar-brand font-weight-bolder ms-sm-3" href="<?php echo e(route('gym.list')); ?>" rel="tooltip">
                                Daftar Gym
                            </a>
                            <a class="text-sm navbar-brand font-weight-bolder ms-sm-3" href="<?php echo e(route('about.index')); ?>" rel="tooltip">
                                Tentang Kami
                            </a>
                                    ...
                                    <div class="dropdown">
                                        <a href="#" class="navbar-brand font-weight-bolder ms-sm-2 rounded-circle me-1" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                            <?php if(Auth::user()->profile_photo): ?>
                                                <img src="<?php echo e(asset('storage/' . Auth::user()->profile_photo)); ?>" alt="profile" class="rounded-circle me-2" width="40" height="40" style="object-fit: cover;">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('assets/images/faces/default.jpg')); ?>" class="rounded-circle me-2" width="40" height="40" style="object-fit: cover;">
                                            <?php endif; ?>
                                            <span class="text-sm"><?php echo e(Auth::user()->name); ?></span> <!-- Tambahkan span dengan kelas text-sm -->
                                        </a>
                                        <ul class="dropdown-menu navbar-brand font-weight-bolder ms-sm-3" aria-labelledby="userDropdown">
                                            <li><a class="text-sm dropdown-item navbar-brand font-weight-bolder ms-sm-3" href="<?php echo e(route('profile.index')); ?>">Profil Saya</a></li>
