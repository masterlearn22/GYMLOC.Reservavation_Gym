...
<body>
    ...
    <section class="">
        <!-- Jumbotron -->
        <div class="px-4 py-5 text-center px-md-5 text-lg-start" style="background-color: hsl(0, 0%, 96%)">
            <div class="container">
                <div class="row gx-lg-5 align-items-center">
                    <div class="mb-5 col-lg-6 mb-lg-0">
                        ...
                        <p style="color: hsl(217, 10%, 50.8%)">
                            Slogan "HEBAT" memiliki makna mendalam, yaitu bahwa mahasiswa harus mengikuti aturan yang
                            telah ditetapkan dalam menjunjung harkat, martabat, moral, dan tata susila.
                            UNAIR juga memiliki motto "Excellence with Morality". Motto ini memiliki arti bahwa
                            mahasiswa harus menjunjung tinggi nilai luhur ajaran agama dan budaya bangsanya dan memiliki
                            pemikiran yang kritis untuk mengetahui ilmu pengetahuan yang tidak ada batasnya.
                    ...
                    <div class="mb-5 col-lg-6 mb-lg-0">
                        <div class="card">
                            <div class="py-5 card-body px-md-5">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-check">
                                            <a href="/login">Sudah Punya Akun? Login here</a>
                                        </div>
                                    </form>                                         
                                </div>
                                </form>
