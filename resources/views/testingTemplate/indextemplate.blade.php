...
<body class="bg-gray-200 index-page">
    ...
    <div class="container top-0 position-sticky z-index-sticky">
        <div class="row">
            <div class="col-12">
                <nav
                    class="top-0 p-2 mx-4 my-3 shadow navbar navbar-expand-lg blur border-radius-xl z-index-fixed position-absolute start-0 end-0">
                                ...
                                <li class="mx-2 nav-item dropdown dropdown-hover">
                                    ...
                                    <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation ms-n3 dropdown-md border-radius-xl mt-lg-3"
                                        ...
                                        <div class="d-none d-lg-block">
                                            <h6
                                                class="px-1 dropdown-header text-dark font-weight-bolder d-flex align-items-center">
                                                Landing Pages
                                            </h6>
                                            ...
                                            <h6
                                                class="px-1 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">
                                                Account
                                            </h6>
            ...
            <div class=" row">
                <div class="mb-4 col-md-3 ms-auto">
                    <div>
                        ...
                        <h6 class="mb-4 font-weight-bolder">GYMLOC</h6>
                    </div>
                    <div>
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="my-4 text-sm text-dark font-weight-normal">
