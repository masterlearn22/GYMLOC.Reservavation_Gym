<nav class="px-0 mx-3 shadow-none navbar navbar-main navbar-expand-lg border-radius-xl" id="navbarBlur" data-scroll="true">
      ...
      <div class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4" id="navbar">
        ...
        <ul class="navbar-nav d-flex align-items-center justify-content-end">
          <li class="nav-item d-flex align-items-center">
            <a class="mb-0 btn btn-outline-primary btn-sm me-3" target="_blank" href="https://www.creative-tim.com/builder?ref=navbar-material-dashboard">Online Builder</a>
          </li>
          <li class="mt-1">
          ...
          <li class="nav-item d-flex align-items-center">
            <a href="../pages/sign-in.html" class="px-0 nav-link text-body font-weight-bold">
